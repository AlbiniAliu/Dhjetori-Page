    ...
    <section className="mx-auto w-full max-w-[1600px] px-6 py-14 sm:px-10 lg:px-16 lg:py-24">
      ...
      <div className="mt-20">
        ...
        <div className="grid items-start gap-10 pt-10 lg:grid-cols-[minmax(0,1fr)_300px] lg:gap-14">
          <div>
            ...
            <div className="mt-10 grid gap-4 sm:grid-cols-2">
              {[1, 2].map((item) => (
                <div
                  key={item}
                  className="relative flex min-h-[14rem] items-center justify-center overflow-hidden bg-[var(--color-panel)] text-white shadow-[0_24px_50px_rgba(0,0,0,0.16)] sm:min-h-[18rem]"
                >
                  <div className="absolute inset-0 bg-[linear-gradient(180deg,_rgba(255,255,255,0.18),_transparent_22%),radial-gradient(circle_at_50%_15%,_rgba(255,255,255,0.16),_transparent_18%),linear-gradient(180deg,_#0d0d0d_0%,_#1b1b1b_45%,_#050505_100%)]" />
                  <div className="relative flex h-20 w-20 items-center justify-center rounded-full border border-white/20 bg-white/8">
                    <ImageIcon />
                  </div>
                </div>
              ))}
          ...
          <aside className="border border-[var(--color-rule)] bg-[rgba(255,255,255,0.45)] p-5 shadow-[0_18px_35px_rgba(0,0,0,0.08)]">
            ...
            <div className="mt-6 grid grid-cols-3 gap-3">
              {releases.map((release) => (
                <div key={release} className="space-y-2">
                  <div className="flex aspect-square items-center justify-center bg-[var(--color-panel)] text-white">
                    <ImageIcon />
                  </div>
